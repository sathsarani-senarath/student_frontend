        ...
        >
            ...
            <div className="relative w-full h-full">
              ...
              >
                <div className="relative w-64 h-64">
                  ...
                  <div className="absolute w-3/4 h-3/4 rounded-full bg-indigo-500 opacity-30 animate-pulse" style={{ animationDelay: '0.3s' }}></div>
                  <div className="absolute w-1/2 h-1/2 rounded-full bg-purple-500 opacity-40 animate-pulse" style={{ animationDelay: '0.6s' }}></div>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-blue-100 mb-8">Sign in to access your personalized dashboard and continue your learning journey.</p>
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12">
            ...
            >
              ...
              <h1 className="text-3xl font-extrabold text-center text-gray-800 mb-2">Sign In</h1>
